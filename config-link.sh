...
if ln -sf ~/dorrel-nixos/modules/common/home/config/* ./ ; then
...
if [ $configType == "nix" ]; then
    if ln -sf ~/dorrel-nixos/modules/nixos/home/config/* ./ ; then
    ...
    if ln -sf ~/dorrel-nixos/modules/darwin/home/config/* ./ ; then
